...
public record PostRatingCommand(RatingId id, Content content, Media media, ProductId productId, RatingPoint ratingPoint, UserAvatar userAvatar,UserId userId, Username username) {
