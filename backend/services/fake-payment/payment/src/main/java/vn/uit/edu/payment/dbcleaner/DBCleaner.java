...
public class DBCleaner {
    ...
    public DBCleaner(
            ...
            OnlinePaymentExpiredDocumentRepository onlinePaymentExpiredRepo,
            PaymentSuccessDocumentRepository paymentSuccessRepo,
            SpringDataPaymentJpaRepository paymentRepo,
            SpringDataOnlinePaymentInfoJpaRepository onlinePaymentRepo) {
