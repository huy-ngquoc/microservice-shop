...
public class EmailMessageConverter {
    ...
    public CreateEmailCommand toCommand(
            String emailContent,
            String emailTitle,
            String emailType,
            UUID orderId,
            String userEmail,
            UUID userId) {
        return new CreateEmailCommand(new EmailContent(emailContent), new EmailTitle(emailTitle),
                new EmailType(emailType), new OrderId(orderId), new UserEmail(userEmail), new UserId(userId));
    }

    public String getCodOrderCreatedContent(
            UUID orderId) {
    ...
    public String getErrorContent(
        ...
        content.append("Chào bạn,\n\n");
        content.append(
                "Đơn hàng của bạn đã không được tiếp nhận do lỗi kỹ thuật. Dưới đây là thông tin quan trọng:\n\n");

        content.append("1. Xem chi tiết đơn hàng tại đây:\n");
        content.append(ORDER_PREFIX).append(orderId.toString()).append("\n\n");

        content.append("Chúng tôi vô cùng xin lỗi vì sự bất tiện này\n");
    ...
    public String getInsufficientStockContent(
            UUID orderId) {
        StringBuilder content = new StringBuilder();

        content.append("Chào bạn,\n\n");
        content.append(
                "Rất tiếc, đơn hàng của bạn không được tiếp nhận do sản phẩm đã hết hàng. Dưới đây là thông tin quan trọng:\n\n");
    ...
    public String getOrderCancelledContent(
            UUID orderId) {
        StringBuilder content = new StringBuilder();
        content.append("Chào bạn,\n\n");
    ...
    public String getOrderShippedContent(
            UUID orderId) {
        StringBuilder content = new StringBuilder();
        content.append("Chào bạn,\n\n");
    ...
    public String getOrderReceivedContent(
            UUID orderId) {
        StringBuilder content = new StringBuilder();
        content.append("Chào bạn,\n\n");
    ...
    public String getPaymentLinkCreatedContent(
            UUID orderId,
            String paymentLink) {
        StringBuilder content = new StringBuilder();
    ...
    public String getPaymentLinkExpiredContent(
            UUID orderId) {
        StringBuilder content = new StringBuilder();
    ...
    public String getPaymentOnlineSuccessExpiredContent(
            UUID orderId) {
        StringBuilder content = new StringBuilder();

        content.append("Chào bạn,\n\n");
        content.append(
                "Cảm ơn bạn đã thanh toán, đơn hàng của bạn đang được xử lý. Dưới đây là thông tin quan trọng:\n\n");
