...
public record EmailType(String value) {
    private static final Set<String> VALID_TYPE = Set.of("ORDER_CREATED","ORDER_RECEIVED","ORDER_SHIPPED","ORDER_CANCELLED","PAYMENT_LINK_CREATED","ONLINE_PAYMENT_SUCCESS","PAYMENT_LINK_EXPIRED");
    public EmailType {
