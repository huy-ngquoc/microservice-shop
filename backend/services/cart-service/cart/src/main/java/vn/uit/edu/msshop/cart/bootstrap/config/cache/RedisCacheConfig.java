package vn.uit.edu.msshop.cart.bootstrap.config.cache;
...
import vn.uit.edu.msshop.cart.bootstrap.config.properties.RedisCacheProperties;
...
public class RedisCacheConfig
    ...
    CacheManager cacheManager(
        ...
        final var configs = Map.<String, RedisCacheConfiguration>ofEntries(
                Map.entry(CacheNames.CART_BY_USER_ID, base.entryTtl(props.cartByUserIdTtl())));
