...
public class OnlinePaymentEntityMapper {
    ...
    public OnlinePaymentInfo toDomain(OnlinePaymentInfoJpaEntity entity) {
        return new OnlinePaymentInfo(new PaymentId(entity.getId()), new PaymentLink(entity.getPaymentLink()), new OnlinePaymentNumber(entity.getPaymentCode()), new TransactionId(entity.getTransactionId()));
    }
    public OnlinePaymentInfoJpaEntity toEntity(OnlinePaymentInfo domain) {
        ...
        return new OnlinePaymentInfoJpaEntity(domain.getPaymentId().value(), mapper.toEntity(p), domain.getPaymentNumber().value(), domain.getLink().value(), domain.getTransactionId().value());
    }
}
