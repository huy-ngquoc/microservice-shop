...
public class CreateOnlinePaymentInfoService implements CreateOnlinePaymentInfoUseCase {
    ...
    public String createPaymentLink(
        ...
        OnlinePaymentInfo info = new OnlinePaymentInfo(payment.getPaymentId(),
                new PaymentLink(paymentLink.getCheckoutUrl()), new OnlinePaymentNumber(orderCode),
                new TransactionId(null), new CreateAt(Instant.now()));
