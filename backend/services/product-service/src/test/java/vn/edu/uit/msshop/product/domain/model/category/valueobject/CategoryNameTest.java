...
final class CategoryNameTest {
    @Test
    @DisplayName("Throw IllegalArgumentException when instantiated with null name")
    ...
    @ValueSource(
            strings = { "", "   ", "\t", "\n" })
    @DisplayName("Throw IllegalArgumentException when name is empty or blank")
    ...
    @Test
    @DisplayName("Throw IllegalArgumentException when name exceeds maximum length")
