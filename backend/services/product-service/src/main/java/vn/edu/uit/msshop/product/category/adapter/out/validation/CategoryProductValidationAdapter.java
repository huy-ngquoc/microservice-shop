...
public class CategoryProductValidationAdapter
    ...
    public boolean existsActiveByCategoryId(
        ...
        final var query = new ProductActiveExistenceCheckByCategoryIdQuery(categoryId.value());
    ...
    public boolean existsSoftDeletedByCategoryId(
            final CategoryId categoryId) {
        final var query = new ProductSoftDeletedExistenceCheckByCategoryIdQuery(categoryId.value());
