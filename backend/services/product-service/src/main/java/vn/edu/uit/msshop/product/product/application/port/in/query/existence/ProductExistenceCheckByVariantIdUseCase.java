...
/**
 * Checks whether ANY product still references the given variant in its embedded
 * variant projection,
 * regardless of the product's deletion state.
 *
 * <p>
 * This is intentionally NOT limited to active products: a soft-deleted product
 * keeps its variant
 * projection and may be restored, so a variant it references must not be
 * hard-deleted. Used to guard
 * variant purge.
 */
