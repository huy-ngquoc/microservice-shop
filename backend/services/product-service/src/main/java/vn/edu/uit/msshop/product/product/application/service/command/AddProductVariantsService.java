...
public class AddProductVariantsService implements AddProductVariantsUseCase {
  ...
  @Override
  @Transactional
  public ProductView addVariants(final AddProductVariantsCommand command) {
    ...
    final var createdVariants =
        this.createAllVariantsPort.create(productId, product.getName(), command.newVariants());
