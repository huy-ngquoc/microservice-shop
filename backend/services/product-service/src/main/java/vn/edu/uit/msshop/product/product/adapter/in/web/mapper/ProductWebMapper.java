...
public class ProductWebMapper {
  public CreateProductCommand toCreateCommand(final CreateProductRequest request) {
    ...
    final var variantsList = request.variants().stream()
        .map(v -> NewProductVariant.of(v.price(), v.traits(), v.targets())).toList();
    ...
    return new CreateProductCommand(name, categoryId, brandId, newConfiguration);
  }
  ...
  public CreateSimpleProductCommand toCreateSimpleCommand(
    ...
    return new CreateSimpleProductCommand(name, categoryId, brandId, price, targets);
  }

  public RestoreProductCommand toRestoreCommand(final UUID id, final long expectedVersion) {
  ...
  public AddProductOptionCommand toAddOptionCommand(final UUID id,
  ...
  public AddProductVariantsCommand toAddVariantsCommand(final UUID id,
  ...
  public UpdateProductInfoCommand toUpdateInfoCommand(final UUID id,
  ...
  public UpdateProductOptionCommand toUpdateOptionCommand(final UUID id, final int index,
  ...
  public RemoveProductOptionCommand toRemoveOptionCommand(final UUID id, final int index,
  ...
  public SoftDeleteProductCommand toSoftDeleteCommand(final UUID id, final long expectedVersion) {
    final var productId = new ProductId(id);
    final var version = new ProductVersion(expectedVersion);
  ...
  public HardDeleteProductCommand toHardDeleteCommand(final UUID id, final long expectedVersion) {
    final var productId = new ProductId(id);
    final var version = new ProductVersion(expectedVersion);
  ...
  public ProductId toProductId(final UUID id) {
    return new ProductId(id);
  }

  public ProductResponse toResponse(final ProductView view) {
  ...
  public ProductVariantResponse toVariantResponse(final ProductVariantView view) {
