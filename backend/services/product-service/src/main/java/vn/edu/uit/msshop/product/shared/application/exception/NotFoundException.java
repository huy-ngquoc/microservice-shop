...
public class NotFoundException extends RuntimeException {
  ...
  public NotFoundException(final String resource, final String identifier) {
  ...
  private static String buildMessage(final String resource, final String identifier) {
    final String r;
