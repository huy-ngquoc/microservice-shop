...
public interface PublishBrandEventPort {
  void publish(final BrandCreated event);

  void publish(final BrandUpdated event);

  void publish(final BrandLogoUpdated event);

  void publish(final BrandSoftDeleted event);

  void publish(final BrandRestored event);

  void publish(final BrandPurged event);
}
