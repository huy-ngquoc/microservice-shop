...
public class BrandWebMapper {
  ...
  public CreateBrandCommand toCreateCommand(final CreateBrandRequest request) {
    final var name = new BrandName(request.name());

    return new CreateBrandCommand(name);
  }

  public RestoreBrandCommand toRestoreCommand(final UUID id, final long expectedVersion) {
  ...
  public UpdateBrandInfoCommand toUpdateInfoCommand(final UUID id,
  ...
  public UpdateBrandLogoCommand toUpdateLogoCommand(final UUID id,
  ...
  public DeleteBrandLogoCommand toDeleteLogoCommand(final UUID id, final long expectedVersion) {
    final var brandId = new BrandId(id);
    final var version = new BrandVersion(expectedVersion);
  ...
  public SoftDeleteBrandCommand toSoftDeleteCommand(final UUID id, final long expectedVersion) {
    final var brandId = new BrandId(id);
    final var version = new BrandVersion(expectedVersion);
  ...
  public HardDeleteBrandCommand toHardDeleteCommand(final UUID id, final long expectedVersion) {
    final var brandId = new BrandId(id);
    final var version = new BrandVersion(expectedVersion);
  ...
  public BrandId toBrandId(final UUID id) {
    return new BrandId(id);
  }

  public BrandResponse toResponse(final BrandView view) {
    return new BrandResponse(view.id(), view.name(), this.toLogoUrlString(view.logoKey()),
        view.version());
  }

  public BrandLogoResponse toLogoResponse(final BrandLogoView view) {
    return new BrandLogoResponse(view.id(), this.toLogoUrlString(view.logoKey()), view.version());
  }

  private static BrandLogoKey extractKeyFromTempPublicId(final String publicId) {
  ...
  private @Nullable String toLogoUrlString(@Nullable final String keyString) {
