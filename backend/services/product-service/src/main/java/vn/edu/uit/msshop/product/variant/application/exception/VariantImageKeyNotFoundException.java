...
public final class VariantImageKeyNotFoundException extends NotFoundException {
  public VariantImageKeyNotFoundException(final VariantImageKey imageKey, final Throwable cause) {
    super("Variant image key", imageKey.value(), cause);
  }

  public VariantImageKeyNotFoundException(final VariantImageKey imageKey) {
