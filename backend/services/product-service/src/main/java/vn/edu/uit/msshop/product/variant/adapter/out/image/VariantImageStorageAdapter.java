...
public class VariantImageStorageAdapter implements VariantImageStoragePort {
  ...
  @Override
  public boolean existsAsTemp(final VariantImageKey key) {
    try {
      final var result =
  ...
  @Override
  public void publishImage(final VariantImageKey key) {
  ...
  @Override
  public void unpublishImage(final VariantImageKey key) {
  ...
  @Override
  public void deleteImage(final VariantImageKey key) {
    try {
