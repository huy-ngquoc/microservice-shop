...
public final class CategoryImageKeyNotFoundException extends NotFoundException {
  public CategoryImageKeyNotFoundException(final CategoryImageKey imageKey, final Throwable cause) {
    super("Category image key", imageKey.value(), cause);
  }

  public CategoryImageKeyNotFoundException(final CategoryImageKey imageKey) {
