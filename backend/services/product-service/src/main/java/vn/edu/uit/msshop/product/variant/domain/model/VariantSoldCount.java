...
public final class VariantSoldCount {
  ...
  public VariantSoldCount(final VariantId id, final VariantProductId productId,
  ...
  public static VariantSoldCount zero(final VariantId id, final VariantProductId productId) {
    final var value = VariantSoldCountValue.zero();

    return new VariantSoldCount(id, productId, value);
  }
}
