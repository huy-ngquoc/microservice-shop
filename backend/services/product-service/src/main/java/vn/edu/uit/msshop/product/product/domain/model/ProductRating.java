...
public final class ProductRating {
  ...
  public ProductRating(final ProductId id, final ProductRatingAverage average,
  ...
  public static ProductRating zero(final ProductId id) {
  ...
  private static void validate(final ProductRatingAverage average,
      final ProductRatingAmount amount) {
