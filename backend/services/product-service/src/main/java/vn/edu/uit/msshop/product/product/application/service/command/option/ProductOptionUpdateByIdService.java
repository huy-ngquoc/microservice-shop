...
class ProductOptionUpdateByIdService
        implements ProductOptionUpdateByIdUseCase {
    ...
    public ProductView update(
            final ProductOptionUpdateByIdCommand cmd) {
        ...
        final var next = ProductOptionUpdateByIdService.applyChanges(
                product,
                cmd.optionIndex(),
                newOption);
        if (next == null) {
