...
public final class ProductBrandNotFoundException extends NotFoundException {
  public ProductBrandNotFoundException(final ProductBrandId brandId, final Throwable cause) {
    super("Product brand", brandId.value().toString(), cause);
  }

  public ProductBrandNotFoundException(final ProductBrandId brandId) {
