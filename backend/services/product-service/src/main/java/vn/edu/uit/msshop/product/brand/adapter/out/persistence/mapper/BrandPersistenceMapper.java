...
public class BrandPersistenceMapper {
  public Brand toDomain(final BrandDocument entity) {
  ...
  public BrandDocument toPersistence(final Brand brand) {
  ...
  public BrandDocument toPersistence(final NewBrand newBrand) {
