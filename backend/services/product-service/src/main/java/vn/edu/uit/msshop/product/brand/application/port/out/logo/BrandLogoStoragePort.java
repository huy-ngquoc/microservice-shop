...
public interface BrandLogoStoragePort {
  boolean existsAsTemp(final BrandLogoKey key);

  void publishLogo(final BrandLogoKey key);

  void unpublishLogo(final BrandLogoKey key);

  void deleteLogo(final BrandLogoKey key);
}
