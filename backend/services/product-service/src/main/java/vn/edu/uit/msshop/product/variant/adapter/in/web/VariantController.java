...
public class VariantController {
  ...
  public ResponseEntity<PageResponseDto<VariantResponse>> list(
    ...
    final var query = this.mapper.toListQuery(page, size, sortBy, direction, targets);
  ...
  @GetMapping("/{id}")
  public ResponseEntity<VariantResponse> findById(@PathVariable final UUID id) {
  ...
  @GetMapping("/{id}/image")
  public ResponseEntity<VariantImageResponse> findImageById(@PathVariable final UUID id) {
  ...
  public ResponseEntity<VariantResponse> findSoftDeletedById(@PathVariable final UUID id) {
    final var view = this.findSoftDeletedUseCase.findSoftDeletedById(this.mapper.toVariantId(id));
  ...
  public ResponseEntity<VariantResponse> updateInfo(@PathVariable final UUID id,
  ...
  public ResponseEntity<VariantImageResponse> updateImage(@PathVariable final UUID id,
  ...
  public ResponseEntity<VariantImageResponse> deleteImageById(@PathVariable final UUID id,
