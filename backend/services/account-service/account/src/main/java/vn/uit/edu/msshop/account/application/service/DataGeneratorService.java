...
public class DataGeneratorService {
    ...
    private int COUNT=0;
    public DataGeneratorService( CreateAccountUseCase createUseCase, AccountWebMapper mapper) {
    ...
    public void generateRegistrationData() {
        ...
        CreateAccountRequest request = new CreateAccountRequest(name, email, password, role, email, phone, phone,firstName, lastName);
