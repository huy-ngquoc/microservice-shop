...
public class CreateAccountService implements CreateAccountUseCase {
    ...
    public AccountView create(
        ...
        String userId = UUIDs.newId().toString();

        final var draft = Account.Draft.builder().id(new AccountId(UUID.fromString(userId)))
                .name(createAccountCommand.name())
                .email(createAccountCommand.email()).password(createAccountCommand.password())
                .role(createAccountCommand.role()).status(new AccountStatus("PENDING"))
                .shippingAddress(createAccountCommand.shippingAddress()).phoneNumber(createAccountCommand.phoneNumber())
                .build();
