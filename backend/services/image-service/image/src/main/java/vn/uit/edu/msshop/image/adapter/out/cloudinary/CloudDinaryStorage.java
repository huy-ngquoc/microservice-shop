...
public class CloudDinaryStorage implements DeleteImagePort, GetSignaturePort, RemoveImageFolderPort {
    ...
    public CloudDinaryStorage(
            ...
            KafkaTemplate<String, ImageRemoveFail> kafkaTemplate) {
    ...
    public ImageInfo remove(
        ...
        return new ImageInfo(new ImageUrl(url), new ImagePublicId(publicId), new ImageFileName(fileName),
                new ImageWidth(width), new ImageHeight(height), new ImageSize(sizeInBytes));
