...
public class TestInventoryService {
    ...
    public List<VariantSumDto> reader(
    ...
    public TestInventoryService(
        ...
        List<InventoryResponse> responses = inventoryChecker
                .getByVariantIds(dtos.stream().map(item -> item.getVariantId()).toList()).getBody();
