...
public class DBCreator {
    ...
    public DBCreator(
            VariantInfoRepository variantInfoRepo,
            InventoryChecker inventoryCreator) {
    ...
    private VariantInfo generateRandomVariantInfo(
            Random rand) {
        return new VariantInfo(UUIDs.newId(), UUIDs.newId(), "", rand.nextInt(10000, 1000000), new ArrayList<>(), "");
    }
}
