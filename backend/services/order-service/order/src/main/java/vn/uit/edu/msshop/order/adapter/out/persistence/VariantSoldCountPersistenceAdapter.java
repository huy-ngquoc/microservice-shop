...
public class VariantSoldCountPersistenceAdapter implements CreateVariantSoldCountPort, FindVariantSoldCountPort,
        UpdateVariantSoldCountPort, DeleteVariantSoldCountPort {
    private final VariantSoldCountRepository variantSoldCountRepo;
    private final VariantSoldCountDataMapper mapper;

    @Override
    public VariantSoldCount create(
            VariantSoldCount variantSoldCount) {
    ...
    @Override
    public List<VariantSoldCount> updateMany(
            List<VariantSoldCount> variantSoldCounts) {
