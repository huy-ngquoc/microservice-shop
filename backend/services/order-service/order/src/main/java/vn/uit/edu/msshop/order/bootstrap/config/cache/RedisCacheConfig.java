package vn.uit.edu.msshop.order.bootstrap.config.cache;
...
import vn.uit.edu.msshop.order.bootstrap.config.properties.RedisCacheProperties;
...
public class RedisCacheConfig
    ...
    CacheManager cacheManager(
        ...
        final var configs = Map.<String, RedisCacheConfiguration>ofEntries(
                Map.entry(CacheNames.ORDERS, base.entryTtl(props.orderTtl())),
                Map.entry(CacheNames.VARIANT_SOLD_COUNT, base.entryTtl(props.variantSoldCountTtl())));
