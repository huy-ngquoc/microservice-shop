...
public class CreatePaymentService {
    ...
    public void createPayment(
        ...
        try {
            ...
            if (!order.getStatus().value().equals("PENDING_PAYMENT"))
                return;
    ...
    public void handleFailure(
        ...
        if (retries >= 20) {
            ...
            if (order == null)
                return;
            final var toSave = order.updateStatus(new OrderStatus("PAYMENT_ERROR"))
                    .updatePaymentStatus(new PaymentStatus("FAILED"));
